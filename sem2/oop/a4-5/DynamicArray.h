...
public:
	...
	void update_movie(int pos, const TElem& e);
...
template<typename TElem>
void DynamicArray<TElem>::add_movie(const TElem& e) {
...
template<typename TElem>
void DynamicArray<TElem>::delete_movie(int pos) {
...
template<typename TElem>
void DynamicArray<TElem>::update_movie(int pos, const TElem& e) {
	this->elems[pos] = e;
}
